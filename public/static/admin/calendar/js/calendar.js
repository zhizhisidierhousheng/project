...
function jcr(d) {
    var jcrjx;
    if (d == '建') jcrjx = '<span style="vertical-align:middle; margin:1px; font-size:12px"><img src="/static/admin/calendar/images/yi.gif"/></span>&nbsp;出行.上任.会友.上书.见工<br><br><span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/ji.gif"/></span>&nbsp;动土.开仓.嫁娶.纳采';
    if (d == '除') jcrjx = '<span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/yi.gif"/></span>&nbsp;除服.疗病.出行.拆卸.入宅<br><br><span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/ji.gif"/></span>&nbsp;求官.上任.开张.搬家.探病';
    if (d == '满') jcrjx = '<span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/yi.gif"/></span>&nbsp;祈福.祭祀.结亲.开市.交易<br><br><span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/ji.gif"/></span>&nbsp;服药.求医.栽种.动土.迁移';
    if (d == '平') jcrjx = '<span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/yi.gif"/></span>&nbsp;祭祀.修填.涂泥.余事勿取<br><br><span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/ji.gif"/></span>&nbsp;移徙.入宅.嫁娶.开市.安葬';
    if (d == '定') jcrjx = '<span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/yi.gif"/></span>&nbsp;易.立券.会友.签约.纳畜<br><br><span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/ji.gif"/></span>&nbsp;种植.置业.卖田.掘井.造船';
    if (d == '执') jcrjx = '<span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/yi.gif"/></span>&nbsp;祈福.祭祀.求子.结婚.立约<br><br><span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/ji.gif"/></span>&nbsp;开市.交易.搬家.远行';
    if (d == '破') jcrjx = '<span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/yi.gif"/></span>&nbsp;求医.赴考.祭祀.余事勿取<br><br><span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/ji.gif"/></span>&nbsp;动土.出行.移徙.开市.修造';
    if (d == '危') jcrjx = '<span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/yi.gif"/></span>&nbsp;经营.交易.求官.纳畜.动土<br><br><span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/ji.gif"/></span>&nbsp;登高.行船.安床.入宅.博彩';
    if (d == '成') jcrjx = '<span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/yi.gif"/></span>&nbsp;祈福.入学.开市.求医.成服<br><br><span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/ji.gif"/></span>&nbsp;词讼.安门.移徙';
    if (d == '收') jcrjx = '<span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/yi.gif"/></span>&nbsp;祭祀.求财.签约.嫁娶.订盟<br><br><span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/ji.gif"/></span>&nbsp;开市.安床.安葬.入宅.破土';
    if (d == '开') jcrjx = '<span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/yi.gif"/></span>&nbsp;疗病.结婚.交易.入仓.求职<br><br><span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/ji.gif"/></span>&nbsp;安葬.动土.针灸';
    if (d == '闭') jcrjx = '<span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/yi.gif"/></span>&nbsp;祭祀.交易.收财.安葬<br><br><span style="vertical-align:middle; margin:1px;"><img src="/static/admin/calendar/images/ji.gif"/></span>&nbsp;宴会.安床.出行.嫁娶.移徙';
    return(jcrjx);
}
...
function mOck(thisObj, v,i){
	...
	//var sssss=document.getElementById(ymd).value;<img id='imgchlik' src='/static/admin/calender/img/false.png'/>加×号的
	// if (type=="workday" || type=="seldaywork") {  //特殊工作日
	// 	if (onoff == "0") {
	// 		dayJson += '0}';//添加修改数据
	// 		thisObj.attributes["on"].value='1';
	// 		document.getElementById("setholiday").innerHTML += "<span class='date' id="+ymd+">"+ymd+"   "+"<img id='imgclick' value='"+ymd+"' onClick='imgonclick("+ymd+","+ids+","+lx+")' src=''/></span>";//将内容加入框中
	...
	// 		dayJson += '1}';//添加修改数据
	// 		thisObj.attributes["on"].value='1';
	// 		document.getElementById("setworkday").innerHTML += "<span  class='date' id="+ymd+">"+ymd+"   "+"<img id='imgclick' value='"+ymd+"' onClick='imgonclick("+ymd+","+ids+","+lx+")' src=''/></span>";//将内容加入框中
...
$('.ymNaviBtn').click(function () {
	font.parent('td').css('background', 'white');
	setTimeout(function(){
		for ( var i = font.length - 1; i >= 0; i--) {
			if ($('#SD'+i).html() == date) {
				$('#SD'+i).parent('td').css('background', '#81BEF7');
			}
		};
	},100);
});

$(".ymNaviBtn").trigger("click");
