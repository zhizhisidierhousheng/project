	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>{{$row->name}}</td>
				<td class="td-manage">
					<a style="text-decoration:none" href="javascript:void(0)" title="分配权限" onclick="layer_show('分配权限', '/authrole/{{$row->id}}', 800, 500)"><i class="Hui-iconfont">&#xe61d;</i></a> 

					<a title="修改角色名" href="/adminrolelist/{{$row->id}}/edit"  class="ml-5" style="text-decoration:none"> <i class="Hui-iconfont">&#xe6df;</i></a> 

					<a title="删除角色" href="javascript:;"  class="ml-5 del" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
				</td>
			</tr>
			@endforeach
		</tbody>
