            ...
            <div class="shopping">
                <table class="table_list">
                    ...
                    <tr class="tr">
                        ...
                        <td class="bgj sp" >
                            <span id="price_item_1">￥<span class="price">{{$row->price}}</span></span>
                        </td>
                        <td class="sl">
                            <div class="Numbers">
                        ...
                        <!--小计 -->
                        <td class="xj">
                            <span>￥</span><span class="xiaoji littleprice">{{$row->price * $row->total}}</span>
                        ...
                        <td class="scj sp">
                            <span id="Original_Price_1"></span>
                        </td>
                    </tr>
                    @endforeach
                    @else
                    <tr class="tr">
                        <center><h1 style="margin-top:130px"><a href="/index">您还没有选购产品 点我继续查看产品</a></h1></center>
                    </tr>
                    @endif
                    <!-- 遍历结束 -->
                </table>
                <div class="sp_Operation clearfix">
                    <div class="select-all">
                        <div class="cart-checkbox">
                            <a href="javascript:void(0);" class="allchoose" style="float:left;margin-left:7px">全选</a>
                        </div>
                        <div class="operation">
                            <a href="javascript:void(0);" class="delchoose" style="float:left;margin-left:7px" onclick="">删除选中</a>
                        </div> 
                    </div>    
                    <!--结算-->
                    <div class="toolbar_right">
                        <ul class="Price_Info">
                            <li class="p_Total"><label class="text">商品总价：</label><span>￥</span><span class="price sumPrice" id="totalprice"></span></li>
