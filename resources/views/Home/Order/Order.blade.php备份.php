    ...
    <div class="Orders_style clearfix">
        ...
        <div class="Address_info">
            <div class="title_name">
                ...
                <a href="javascript:;" data-toggle="modal" onclick="address_add('添加地址','/addaddress','1000','500')">其他收货地址</a>
            </div>
            <ul>
...
<form class="form" method="post" action="/pay"> 
    <fieldset>  
        ...
        <!-- <div class="express_delivery">
            ...
            <ul class="dowebok">
	            <li>
                    <input type="radio" name="radio" data-labelauty="圆通快递">
     ...
     <!-- 这是红包（可以用来做优惠券）  -->
        <!-- <div class="invoice_style">
            <ul>
                ...
                <li class="invoice_left">
                    发票抬头<input name="" type="text" class="text_info" />
                </li>
                <li class="invoice_left">
                    <select name="somename" class="SlectBox" onclick="console.log($(this).val())" onchange="console.log('change is firing')">
     ...
     <!-- 产品列表 -->
        <div class="product_List">
                ...
                <tbody id="goods">
                    ...
                    <tr>                   
                        <td class="Product_info">
                            <a href="#">
                                <img src="{{$r->pic}}" name="pic" width="100px" height="100px"/>
                            </a>
                            <a href="#" name="name" class="product_name goodsname" style="margin-top:-60px;margin-left:270px;">
                                {{$r->name}}
                            </a>
                        </td>
                        <td>
                            <i>￥</i><span name="price">{{$r->price}}</span>
                        </td>
                        <td>{{$r->total}}</td>
                        <td>
                            <i>￥</i>
            ...
            <div class="Pay_info">
                ...
                <span class="wordage">
                    剩余字数：<span id="sy" style="color:Red;">50</span>
                </span>  
            </div>
        <!-- 价格 -->
