                ...
                <div class="pro_ranking"> 
                    ...
                    <div class="ranking_list"> 
                        <ul id="tabRank">
                            ...
                            @if($loop->first)
                            <li class="t_p on">
                                <em class="icon_ranking">{{$loop->iteration}}</em> 
                                <dt>
                ...
                <div class="p_list  clearfix"> 
                    <ul>
                        ...
                        <li class="gl-item">
                            <div class="Borders"> 
                                <div class="img">
                                    <a href="/homegoods/{{$row->id}}" title="{{$row->name}} {{strip_tags($row->dcr)}}"><img src="{{$row->pic}}" style="width:220px;height:220px" /></a>
                                </div> 
                                <div class="Price">
                                    <b>&yen;{{$row->price}}</b>
                                </div> 
                                <div class="name">
                                    <a href="/homegoods/{{$row->id}}" title="{{$row->name}} {{strip_tags($row->dcr)}}">{{$row->name}} {{strip_tags($row->dcr)}}</a>
                                </div> 
                                <div class="p-operate"> 
                                    ...
                                    <a href="/listaddcart/{{$row->id}}" class="p-o-btn shop_cart"><em></em>加入购物车</a> 
                                </div> 
                            </div>
                        </li>
                        @endforeach
