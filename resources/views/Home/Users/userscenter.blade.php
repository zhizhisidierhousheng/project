   ...
   <div class="user_center"> 
    ...
    <div class="right_style"> 
     <div class="info_content"> 
      ...
      <div class="user_info"> 
       <ul class=""> 
        <li class="Balance"><a href="#"><img src="/static/home/images/user_img_05.png" /><h4>余额：￥54.00</h4></a></li> 
        <li class="Order_form"><a href="#"><img src="/static/home/images/user_img_04.png" /><h4>订单：(5)</h4></a></li> 
         ...
         <table> 
          ...
          <tbody> 
           @foreach($orders as $row)
            ...
            @if(count($row->info) > 1)
              <tr> 
               ...
               @foreach($row->info as $info)
                 ...
                 <a href="#" class="img" title="山东红富士苹果"><img src="/static/home/products/p_2.jpg" width="80" height="80" /></a>
                 @else
                 <a href="#" class="img" title="山东红富士苹果"><img src="/static/home/products/p_2.jpg" width="80" height="80" /></a> <i class="icon-copy"></i>
                 @endif
               @endforeach
               </td> 
               <td>{{$row->total}}</td> 
            ...
            @else
              <tr> 
               <td class="img_link"> <a href="#" class="img"><img src="/static/home/products/p_58.jpg" width="80" height="80" /></a> <a href="#" class="title">雅诗兰黛（Estee Lauder）弹性紧实柔肤眼霜15ml(又名弹性紧实眼霜)（提拉紧致 保湿补水 淡化细纹）</a> </td> 
               <td>{{$row->total}}</td> 
               <td>{{$row->status}}</td> 
               <td><a href="#" class="View">查看</a></td> 
              </tr> 
