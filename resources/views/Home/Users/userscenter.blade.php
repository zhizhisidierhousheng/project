        ...
        <div class="right_style"> 
            <div class="info_content"> 
                ...
                <div class="user_info"> 
                    <ul class=""> 
                        <li class="Order_form">
                            <a href="/home/usersorder">
                                <img src="/static/home/images/user_img_04.png" />
                                <h4>订单：(5)</h4>
                            </a>
                        </li> 
                        <li class="grade">
                            <a href="#">
                                <img src="/static/home/images/user_img_08.png" />
                                <h4>优惠券：(3)</h4>
                            </a>
                        </li> 
                    </ul> 
                                    ...
                                    {{--//判断订单是否由多种商品构成--}}
                                        ...
                                        @else
                                            ...
                                            <tr> 
                                                <td class="img_link">
                                                    <a href="#" class="img">
                                                        <img src="{{$info->gpic}}" width="80" height="80" />
                                                    </a>
                                                    <a href="#" class="title">{{$info->gdcr}}</a>
                                                </td>
                                                <td>{{$row->total}}</td> 
                                                <td>{{$row->status}}</td> 
                                                <td>
                                                    <a href="/home/usersorder/{{$info->oid}}" class="View">查看</a>
                                                </td> 
                                            </tr> 
                                            @endforeach
                                        @endif
