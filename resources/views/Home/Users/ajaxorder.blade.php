                ...
                <div class="sideMen"> 
                    ...
                    <dl class="accountSideOption1"> 
                        ...
                        <dd> 
                            <ul> 
                                <li> 
                                    <a href="/home/usersinfo"> 用户信息</a>
                                </li> 
                                <li> 
                                    <a href="/home/userscollect"> 我的收藏</a>
                                </li> 
                                <li> 
                                    <a href="user.php?act=message_list"> 修改密码</a>
                                </li> 
                                <li>
                    ...
                    <dl class="accountSideOption1"> 
                        ...
                        <dd> 
                            <ul> 
                                <li> 
                                    <a href="user.php?act=myshop">密保设置</a>
                                </li> 
                            </ul> 
                        </dd> 
                    </dl> 
        ...
        <div class="right_style"> 
            <div class="info_content"> 
                ...
                <div class="Order_Sort"> 
                    <ul> 
                        <li>
                            <a href="javascript:;" onclick="page(1, 0)">
                                <img src="/static/home/images/icon-dingdan1.png" /><br />待发货（{{count($a)}}）
                            </a>
                        </li> 
                        <li>
                            <a href="javascript:;" onclick="page(1, 1)">
                                <img src="/static/home/images/icon-dingdan.png" /><br />已发货（{{count($b)}}）
                            </a>
                        </li> 
                        <li>
                            <a href="javascript:;" onclick="page(1, 2)">
                                <img src="/static/home/images/icon-kuaidi.png" <="" a="" /><br />派送中（{{count($c)}}）
                            </a>
                        </li>
                        <a href="#"> </a>
                        <li class="noborder" onclick="page(1, 3)">
                            <a href="javascript:;">
                                <img src="/static/home/images/icon-weibiaoti101.png" /><br />已验收（{{count($d)}}）
                            </a>
                        </li> 
                    </ul> 
                </div> 
            ...
            <div class="Paging"> 
                <div class="Pagination" id="pages"> 
                    ...
                    <a href="javascript:;" class="btn" onclick="page({{$num}}, {{$status}})">{{$row}}</a>
                    @endforeach
                </div> 
            </div> 
        </div> 
