   ...
   <div class="user_center"> 
    ...
    <div class="right_style"> 
     <div class="info_content"> 
      ...
      <script>jQuery(".Order_form_list").slide({titCell:".Order_info", targetCell:".Order_Details",defaultIndex:1,delayTime:300,trigger:"click",defaultPlay:true,returnDefault:false});</script> 
     </div> 
     <div class="Paging"> 
