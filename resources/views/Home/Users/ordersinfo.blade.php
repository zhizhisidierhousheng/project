 ...
 <body> 
     ...
     <div class="product_List"> 
      <table> 
       ...
       <tbody>
        ...
        <tr> 
         <td class="Product_info"> <a href="#"><img src="/static/home/products/p_11.jpg" width="100px" height="100px" /></a> <a href="#" class="product_name">麻阳冰糖橙子甜橙冰糖柑8斤新鲜水果甜过永兴冰糖橙赣南脐橙包邮</a> </td> 
      ...
      <div class="price_style"> 
       <div class="right_direction"> 
        <ul> 
         <li><label>商品总价</label><i>￥</i><span>{{$data->total + $data->money}}</span></li>
         <li><label>优惠金额</label><i>￥</i><span>-{{$data->money}}</span></li>
         <li class="shiji_price"><label>实&nbsp;&nbsp;付&nbsp;&nbsp;款</label><i>￥</i><span>{{$data->total}}</span></li> 
        </ul> 
       </div> 
      </div> 
     </div> 
  ...
  <div class="fixedBox"> 
   <ul class="fixedBoxList"> 
    ...
    <li class="fixeBoxLi cart_bd" style="display:block;" id="cartboxs"> <p class="good_cart">0</p> <span class="fixeBoxSpan iconfont icon-cart"></span> <strong>购物车</strong> 
     <div class="cartBox"> 
      <div class="bjfff"></div>
      <div class="message">
       购物车内暂无商品，赶紧选购吧
    ...
    <li class="fixeBoxLi Service "> <span class="fixeBoxSpan iconfont icon-service"></span> <strong>客服</strong> 
     <div class="ServiceBox"> 
      ...
      <dl onclick="javascript:;"> 
       <dt>
        <img src="/static/home/images/Service1.png" />
       </dt> 
       <dd>
        <strong>QQ客服1</strong> 
    ...
    <li class="fixeBoxLi code cart_bd " style="display:block;" id="cartboxs"> <span class="fixeBoxSpan iconfont icon-erweima"></span> <strong>微信</strong> 
     <div class="cartBox"> 
      <div class="bjfff"></div> 
      <div class="QR_code"> 
       <p><img src="/static/home/images/erweim.jpg" width="150px" height="150px" style=" margin-top:10px;" /></p> 
       <p>微信扫一扫，关注我们</p> 
      </div> 
     </div> </li> 
